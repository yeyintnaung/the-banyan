...
<form method="post" action="{{url('mpu_redirect')}}">
    <label>Merchant ID:</label>
    <input type="text" id="merchantID" name="merchantID" value="206104000001545" />
    <br />
    <br />
     
    <label>Invoice No:</label>
    <input type="text" id="invoiceNo" name="invoiceNo" value="100011" />
    <br />
