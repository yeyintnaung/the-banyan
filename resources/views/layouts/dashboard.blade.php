                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="{{''}}" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span id='count' class="badge badge-danger" style="color:white;font-weight:bold;font-size:14px !important;" onclick="window.location.assign('{{'show_unread_requests'}}');"></span>
                                             <span id='countw' class="badge badge-info" style="color:white;font-weight:bold;font-size:14px !important;" onclick="window.location.assign('{{'show_unread_wrequests'}}');"></span>
                                </a>
                            </li>
                            <script>
                                $('body').click(function() {
                                ...
                                $('body').click(function() {
                                    $.get("{{'get_unreadw_requests'}}",function(data,status){
                                        $('#countw').html(data.successw);
                                    });
                                });
                                $(window).load(function() {
                                    $.get("{{'get_unreadw_requests'}}",function(data,status){
