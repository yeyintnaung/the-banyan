...
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Unread Withdraw Requests</span>
                        ...
                        @foreach ($withdraws as $withdraw)
                            <tr>
                                ...
                                <th>
                                    ...
                                    <button class="btn btn-danger pull-left" style="padding:0px 10px !important;" type="button" onClick="location.href='{{ url('mark_as_wread/'.$withdraw->id) }}'">{{ 'Mark as Read' }}</button>
                                    <?php
                                    }
                                    ?>
    ...
    <div class="row">
        @php
            $unread =\Illuminate\Support\Facades\DB::table('withdraws')->where('status','read')->get();
        @endphp
        <div class="col-md-12">
            <!-- BEGIN EXAMPLE TABLE PORTLET-->
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <i class="icon-settings font-dark"></i>
                        <span class="caption-subject bold uppercase">Readed withdraw request</span>
                        ...
                        @foreach ($unread as $un)
                            <tr>
                                ...
                                <th>
                                    ...
                                    ?>
                                    <button class="btn btn-danger pull-left" style="padding:0px 10px !important;" type="button" onClick="location.href='{{ url('mark_as_unread/'.$un->id) }}'">{{ 'Mark as Pending' }}</button>
                                    <?php
                                    }
                                    ?>
