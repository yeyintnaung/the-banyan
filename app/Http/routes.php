...
Route::get('mark_as_wread/{id}', 'WithdrawController@mark_as_wread');
Route::get('mark_as_unread/{id}', 'WithdrawController@mark_as_unread');
...
Route::get('topup_api','ApiController@topup_api');
...
Route::group(['middleware' => 'auth'], function () {
   ...
   Route::get('get_unreadw_requests',function(){
        $count_unread=\Illuminate\Support\Facades\DB::table('withdraws')->where('status','pending')->count();
        return Response::json([
            'successw' => $count_unread, //1,2,3  1 org 2 com 3 maintainance
        ]);
    });
Route::post('all_cc','ApiController@huge_check');
    Route::get('show_unread_wrequests', 'NewmpuController@show_unread_wrequests');
