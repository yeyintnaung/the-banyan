...
class NewmpuController extends Controller
{
    ...
    public function to_gateway(Request $request){
        $request['merchantID']=206104000001545;
    ...
    public function mark_all_as_read(){
      ...
      public function show_unread_wrequests()
    {
        $w_data = DB::table('withdraws')->where('status', '=', 'pending')->get();
        return view('withdraw.pending', ['withdraws' => $w_data]);
    }
}
