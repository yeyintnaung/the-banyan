...
class WithdrawController extends Controller
{
    ...
    public function destroy($id)
    {
       ...
       public function mark_as_wread($id)
    {
        //
        $db=DB::table('withdraws')->where('id',$id)->update(['status'=>'read']);
        flash('Mark as Read Success!');
        return redirect()->back();
    }
    public function mark_as_unread($id)
    {
        //
        $db=DB::table('withdraws')->where('id',$id)->update(['status'=>'pending']);
        flash('Mark as Pending Success!');
        return redirect()->back();
    }
}
